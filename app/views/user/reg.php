...
<body>
    ...
    <div class="container main">
        ...
        <form action="/user/reg" method="post" class="form-control">
            ...
            <input type="password" name="re_pass" placeholder="Повторите пароль" value="<?= isset($_POST['re_pass']) ? $_POST['re_pass'] : '' ?>">
...
<body>
    ...
    <div class="container main">
        ...
        <form action="/user/reg" method="post" class="form-controll">
            ...
            <input type="password" name="re_pass" placeholder="Повторите пороль" value="<?= $_POST['re_pass'] ?? '' ?>"><br>
